...
neonData$velocity=0.6*(neonData$totalDischarge^0.2) # Estimates mean velocity
neonData$travelTime=70000/neonData$velocity # Estimates travel time from USGS to NEON station
neonData$collectDate=neonData$collectDate-neonData$travelTime # Adjusts time offset between stations
neonData$collectDate<-lubridate::round_date(neonData$collectDate,unit="15 minute")
