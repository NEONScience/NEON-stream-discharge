...
siteDirectory<-read.csv('N:/Special/AIS Survey Work/D06_MCDI/MCDI_AIS_Repair_Survey/D06_MCDI/MCDI_AIS_Repair_Survey_20181128_Controls.csv',head=T,sep=",",stringsAsFactors = F) 

N:\Special\AIS Survey Work\D06_MCDI\MCDI_AIS_ Repair_Survey_20181128\Raw_Survey_Data
...
staffGaugePoints=subset(surveyPtsDF,surveyPtsDF$MAPCODE=="Gauge_Perm")
