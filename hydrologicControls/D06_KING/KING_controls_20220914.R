...
#' discharge rating curve for King's Creek for water years 2022-
...
#   Bobby Hensley (12/19/2022)
#     Modified for KING 2022 AIS survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D06_KING_20220914"
URIpath <- paste(filepath,"filesToStack00131","stackedFiles",sep = "/")

# Read in survey points from csv file saved locally on N:/ drive
surveyPtsDF <- read.csv("N:/Science/AQU/Controls/D06_KING_20220914/D06_KING_surveyPts_20220914.csv")
...
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS46"]
