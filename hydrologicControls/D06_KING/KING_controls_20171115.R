...
#' discharge rating curve for Kings Creek for water years 2012-2019.
...
filepath <- "N:/Science/AQU/Controls/D06_KING_20171115"
...
surveyPtsDF <- read.table(paste0(URIpath,"/NEON_D06_KING_GEOMORPH_20171115_L0_VE/KING_surveyPts_20171115.csv"),
                          sep = ",",
                          header = TRUE,
                          stringsAsFactors = FALSE)

#The end date of the geomorphology survey (YYYYMMDD)
surveyActiveDate<-'20171115' 
...
staffGaugePoints=subset(surveyPtsDF,surveyPtsDF$name=="SP_0.5")
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC14"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC6"]
...
geo_controlType_in$controlLeft[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC26"]
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC33"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_PIN_LB"]
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC26"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC2"]
