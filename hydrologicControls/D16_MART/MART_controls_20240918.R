...
#   Bobby Hensley (2024-10-21)
#     Script for MART 2024-09-18 created.
...
dataFromAPI <- neonUtilities::loadByProduct(streamMorphoDPID,siteID,startdate="2024-09", enddate="2024-09",
...
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_1.20M",staffGaugePoints$surveyPointID)]  
...
geo_controlType_in$controlLeft[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS4"]
geo_controlType_in$controlRight[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_LBF"]
...
geo_priorParameters_in$priorActivationStage[2] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS20"]
geo_priorParameters_in$priorActivationStageUnc[2] <- 0.1 
geo_priorParameters_in$priorActivationStage[3] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS8"]
geo_priorParameters_in$priorActivationStageUnc[3] <- 0.3 
