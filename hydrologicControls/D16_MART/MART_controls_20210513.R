...
#' discharge rating curve for Martha Creek for water years 2019-.
...
#   Bobby Hensley (6/7/2020)
#     Modified for MART 2021 survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D16_MART_20210513"
...
surveyPtsDF <- read.csv(file="D16_MART_20210513_surveyPts.csv")
...
staffGaugePoints=subset(surveyPtsDF,surveyPtsDF$name=="SP_1.30M")
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS33"]
