...
#' discharge rating curve for Martha Creek for water years 2022-
...
#   Bobby Hensley (12/14/2022)
#     Modified for MART 2021 AIS survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D16_MART_20210901"
URIpath <- paste(filepath,"filesToStack00131","stackedFiles",sep = "/")

# Read in survey points from csv file saved locally on N:/ drive
surveyPtsDF <- read.csv("N:/Science/AQU/Controls/D16_MART_20210901/D16_MART_surveyPts_20210901.csv")
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS2"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS29"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS7"]
