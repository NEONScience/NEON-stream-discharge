...
#   Bobby Hensley (2023-10-24)
#     Script for COMO 2022-08-31 created.
...
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_0.4M",staffGaugePoints$surveyPointID)]  
...
geo_controlType_in$controlLeft[2] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_LFH"]
...
geo_priorParameters_in$priorActivationStage[2] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_LEW"]
