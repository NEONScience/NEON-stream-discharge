...
#' discharge rating curve for Como Creek for water years 2012-2017.
...
filepath <- "N:/Science/AQU/Controls/D13_COMO_20171101"
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "LEW125"]
