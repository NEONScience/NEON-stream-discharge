...
#   Bobby Hensley (2023-12-13)
#     Script for BLDE 2023-11-08 created.
...
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_.80M",staffGaugePoints$surveyPointID)]  
...
geo_controlType_in$controlLeft[1] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS15"]
...
geo_priorParameters_in$priorActivationStage[3] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_LBF"]
