...
filepath <- "N:/Science/AQU/Controls/D03_FLNT"
URIpath <- paste(filepath,"filesToStack00131","stackedFiles",sep = "/")

# Cross section generated by linking floodplain survey data with ADCP profile
# Right bank was measured, left bank was mirrored



#Read in downloaded data
surveyPtsDF <- read.table(paste0(filepath,"/D03FLNT_surveyPts_20180125.CSV"),
                          sep = ",",
                          header = TRUE,
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="LBANK_25"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="LBANK_25"]
...
dischargeXS1ReferenceDistance <- dischargePointsXS1$DistanceRaw[dischargePointsXS1$name=="LBANK_PIN"]
...
staffGaugeMeterMark <- 0.52
staffGaugeElevation <- staffGaugePoints$H[grepl("SP_0.52M",staffGaugePoints$name)]  
...
geo_controlType_in$controlLeft[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "LBANK_1"]
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "BANK"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "BANK"]
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "ROAD6"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "LBOT"]
geo_priorParameters_in$priorActivationStageUnc[1] <- 0.01

geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "LWEIR"]
geo_priorParameters_in$priorActivationStageUnc[2] <- 0.01

geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "BANK7"]
