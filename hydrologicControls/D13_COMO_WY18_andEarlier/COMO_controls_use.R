...
dischargeXS1ReferenceDistance<-dischargePointsXS1$DistanceRaw[8]
...
staffGaugeElevation <- staffGaugePoints$H[grepl("SP_0.85M",staffGaugePoints$name)]  
...
if(exectpart){
  ...
  staffGaugeZeroElevation<-(staffGaugePoints$H[staffGaugePoints$name=="SP_0.85M"])-staffGaugeMeterMark
