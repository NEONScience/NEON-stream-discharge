...
#' discharge rating curve for Mayfield Creek for water years 2024-
...
#   Bobby Hensley (2025-02-55)
#     Script for MAYF 2025-01-29 created.
######################################################################################################################## 
...
dataFromAPI <- neonUtilities::loadByProduct(streamMorphoDPID,siteID,startdate="2025-01", enddate="2025-01",
...
floodplainPoint$surveyPointID="DSC_RFPLN_0"
floodplainPoint$northing=-15
floodplainPoint$easting=50
floodplainPoint$elevation=998.94
...
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_1.15",staffGaugePoints$surveyPointID)]  

#' Manually enter the staff gauge reading of the point used above (found in surveyPointID name)
staffGaugeMeterMark<-1.15
...
geo_controlType_in$controlLeft[1] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS_LEW"]
...
geo_controlType_in$controlLeft[2] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS_43"]
geo_controlType_in$controlRight[2] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS_3"]
...
geo_controlType_in$controlLeft[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS_3"]
geo_controlType_in$controlRight[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_RFPLN_0"]
...
geo_priorParameters_in$priorActivationStage[2] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS_21"]
