...
#' discharge rating curve for Mayfield Creek for water years 2021-.
...
#     Modified for MAYF 2021-02-03 survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D08_MAYF_20210203"
...
surveyPtsDF <- read.table("~/D08_MAYF_surveyPts_20210203.csv",
                          sep = ",",
                          header = T,
                          stringsAsFactors = F,
                          encoding = "UTF-8")
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="DSC_LFPLN_6"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="DSC_LFPLN_6"]
...
dischargeXS1ReferenceDistance <- dischargePointsXS1$DistanceRaw[dischargePointsXS1$name=="DSC_LFPLN_6"]
...
geo_controlType_in$controlLeft[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS_53"]
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS_8"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS_8"]
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_RFPLN_1"]
...
#Slope calculations (No WE or THL shots. Used slope from previous surveys)
geo_controlType_in$channelSlope[2] <- 0.003
geo_controlType_in$channelSlopeUnc[2] <- 0.003
geo_controlType_in$channelSlope[3] <- 0.003
geo_controlType_in$channelSlopeUnc[3] <- 0.003
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS_22"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS_26"]
