...
staffGaugeMeterMark<-0.31
staffGaugeElevation <- staffGaugePoints$H[grepl("SP_0.31M",staffGaugePoints$name)]  
...
#Sets plot3 settings.  
xAxisTitle3<-list(title="Distance (m)",zeroline=FALSE) #If you want to set Range: , range=c(-5,15)
...
if(exectpart){
  ...
  staffGaugeZeroElevation<-(staffGaugePoints$H[staffGaugePoints$name=="SP_0.31M"])-staffGaugeMeterMark
