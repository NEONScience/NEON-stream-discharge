...
#' discharge rating curve for Mayfield Creek for water years 2019-.
...
#   Bobby Hensley (10/09/2020)
#     Modified for MAYF 2019-12-20 survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D08_MAYF_20191220"
...
surveyPtsDF <- read.table("~/D08_MAYF_surveyPts_20191220.csv",
                          sep = ",",
                          header = T,
                          stringsAsFactors = F,
                          encoding = "UTF-8")
...
surveyActiveDate <- "2019-08-12"  # Date TROLL at DSC2 came online
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="LFPLN_7"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="LFPLN_7"]
...
dischargeXS1ReferenceDistance <- dischargePointsXS1$DistanceRaw[dischargePointsXS1$name=="LFPLN_6"]
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS_14"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS_5"]
...
geo_controlType_in$controlLeft[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS_24"]
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS_REW"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS_34"]
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS_24"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS_7"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS_14"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS_29"]
