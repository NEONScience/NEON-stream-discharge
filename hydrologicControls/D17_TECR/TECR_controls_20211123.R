...
#     Script for TECR 2021-11-23 created.
...
dataFromAPI <- neonUtilities::loadByProduct(streamMorphoDPID,siteID,startdate="2021-11", enddate="2021-11",
...
dscReference <- dsc_surveyPoints$distanceRaw[dsc_surveyPoints$surveyPointID=="DSC_TEMP_PIN"]
...
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_0.75M",staffGaugePoints$surveyPointID)]  
...
geo_controlType_in$controlRight[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_RFH"]
...
geo_priorParameters_in$priorActivationStage[2] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS15"]
