...
#' discharge rating curve for Teakettle Creek for water years 2024-
...
#   Bobby Hensley (2025-02-13)
#     Script for TECR 2023-11-27 created.
######################################################################################################################## 
...
dataFromAPI <- neonUtilities::loadByProduct(streamMorphoDPID,siteID,startdate="2023-11", enddate="2023-11",
...
geo_controlType_in$controlLeft[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS1"]
...
#Slope calculations
#No wetted edge or thalweg points in AIS survey. Using slope from previous geomorph survey
geo_controlType_in$channelSlope[2] <- 0.1
geo_controlType_in$channelSlopeUnc[2] <- 0.1 #Default slope uncertainty is equal to slope
geo_controlType_in$channelSlope[3] <- 0.1
geo_controlType_in$channelSlopeUnc[3] <- 0.1 #Default slope uncertainty is equal to slope
...
geo_priorParameters_in$priorActivationStage[1] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS6"]
geo_priorParameters_in$priorActivationStageUnc[1] <- 0.1
geo_priorParameters_in$priorActivationStage[2] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS4"]
