...
#REDB processing code
filepath <- "C:/Users/kcawley/Desktop/test/"
surveyPtsDF <- read.table(paste0(filepath,"REDB_surveyPts_20171110.csv"),sep = ",",stringsAsFactors = FALSE, header = TRUE)
siteID <- "REDB"
surveyDate <- "2017-11-10T00:00"
