...
#   Bobby Hensley (2024-08-28)
#     Script for REDB 2024-08-29 created.
...
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_0.30M",staffGaugePoints$surveyPointID)]  
...
geo_controlType_in$controlLeft[1] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS28"]
geo_controlType_in$controlRight[1] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS10"]
...
geo_controlType_in$controlRight[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS2"]
