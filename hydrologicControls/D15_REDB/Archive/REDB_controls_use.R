...
dischargeXS1ReferenceDistance<-dischargePointsXS1$DistanceRaw[7]
...
staffGaugeElevation <- staffGaugePoints$H[grepl("PERM_GAUGE_2.00M_RE-SHOT",staffGaugePoints$name)]  
...
if(exectpart){
  ...
  staffGaugeZeroElevation<-(staffGaugePoints$H[staffGaugePoints$name=="PERM_GAUGE_2.00M_RE-SHOT"])-staffGaugeMeterMark
