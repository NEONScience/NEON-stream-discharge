...
#' discharge rating curve for Red Butte Creek for water years 2012-2019.
...
#   Bobby Hensley (4/20/2021)
#     Modified for REDB 2017 survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D15_REDB_20171110"
...
surveyPtsDF <- read.table(paste0(URIpath,"/NEON_D15_REDB_GEOMORPH_20171110_L0_VE/REDB_surveyPts_20171110.CSV"),
                          sep = ",",
                          header = TRUE,
...
#Sets plot2 settings.  
xAxisTitle2<-list(title="Distance (m)",zeroline=FALSE, range=c(-2,5))
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC10"]
...
geo_controlType_in$controlLeft[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "LEW227"]
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "REW230"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "REW230"]
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "RFW11"]
...
geo_controlType_in$channelSlopeUnc[2] <- 0.06
geo_controlType_in$channelSlope[3] <- rise/run
geo_controlType_in$channelSlopeUnc[3] <- 0.06
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC16"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "RBF11"]
