...
filepath <- "N:/Science/AQU/Controls/D11_BLUE_20190918_WY18-19"
...
geo_priorParameters_in$priorActivationStageUnc[1] <- 0.25 # Combined uncertainty associated with survey and actual activation stage (0.1 m default)

geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS10"]
geo_priorParameters_in$priorActivationStageUnc[2] <- 0.25 # Combined uncertainty associated with survey and actual activation stage (0.1 m default)
