...
allData<-read.csv('N:/Special/AIS Survey Work/D11_BLUE/BLUE_AIS_ReDesign_Survey_20181025/Raw_Survey_Data/D11_BLUE_AIS_ReDesign_Raw_Survey_Data_20181025.csv',head=T,sep=",",stringsAsFactors = F) 
...
dischargeXS1NorthStart<-dischargePointsXS1$N[46]
dischargeXS1EastStart<-dischargePointsXS1$E[46]
...
staffGaugeElevation <- staffGaugePoints$H[grepl("SP_0.80",staffGaugePoints$name)]  
