...
geo_controlType_in$rectangularWidthUnc[1] <- 100 #High uncertainty used ADCP data
...
geo_controlType_in$rectangularWidthUnc[2] <- 100 #High uncertainty used ADCP data

#Entries for Control #3
geo_controlType_in$hydraulicControlType[3] <- "Rectangular Channel"
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "LFPLN_4"]
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "LEW"]
...
geo_priorParameters_in$priorActivationStageUnc[1] <- 1 #High uncertainty used ADCP data

geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "LCHANNEL"]
geo_priorParameters_in$priorActivationStageUnc[2] <- 1 #High uncertainty used ADCP data

geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "LEW"]
