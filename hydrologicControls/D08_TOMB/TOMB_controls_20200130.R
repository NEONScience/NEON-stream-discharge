...
leftChannel<-data.frame("LCHANNEL",265.4,119.4,986.37,"Transect")
names(leftChannel)<-c("name","E","N","H","mapCode")
leftWeir<-data.frame("LWEIR",265.4,119.4,986.27,"Transect")
names(leftWeir)<-c("name","E","N","H","mapCode")
rightWeir<-data.frame("RWEIR",38.48,113.2,986.27,"Transect")
names(rightWeir)<-c("name","E","N","H","mapCode")
...
#Sets plot2 settings.  
xAxisTitle2<-list(title="Distance (m)",zeroline=FALSE, range=c(-5,300))
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "REW"]
...
geo_controlType_in$controlLeft[4] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "LFPLN_4"]
geo_controlType_in$controlRight[4] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "LEW"]
...
geo_controlType_in$channelSlopeUnc[4] <- 0.001
...
geo_controlType_in$manningCoefficient[3] <- 0.01
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "REW"]
...
geo_priorParameters_in$priorActivationStage[4] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "LFPLN_1"]
