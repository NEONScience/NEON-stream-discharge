...
#' discharge rating curve for Toolik Lake inlet for water years 2012-.
...
filepath <- "N:/Science/AQU/Controls/D18_TKIN_20200822"
...
L0pull_TKIN<-L0pull_site[(L0pull_site$rawDataFileName=="NEON_D18_TKIN_20200822_AIS_SURVEY_L0_VA.zip"),]  
...
surveyPtsDF <- read.table("~/D18_TKIN_surveyPts_20200822.csv",
                          sep = ",",
                          header = T,
                          stringsAsFactors = F,
                          encoding = "UTF-8")
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="IN_DSC_42"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="IN_DSC_42"]
...
dischargeXS1ReferenceDistance <- dischargePointsXS1$DistanceRaw[dischargePointsXS1$name=="IN_DSC_42"]
...
floodPlain<-data.frame(name=c("IN_DSC_FLD"),E=c(0.0),N=c(0.0),H=c(996.6),mapCode=c("Transect_DSC"),DistanceRaw=c(20.0),DistanceAdj=c(20.0))
...
#Sets plot2 settings.  
xAxisTitle2<-list(title="Distance (m)",zeroline=FALSE, range=c(-1,21))
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_39"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_5"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_28"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_32"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_1"]
