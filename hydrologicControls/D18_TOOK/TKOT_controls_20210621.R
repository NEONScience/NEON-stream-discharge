...
#' discharge rating curve for Toolik Lake outlet for water years 2021-.
...
#   Bobby Hensley (2/22/2022)
#     Modified for TKOT 2021 survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D18_TKOT_20210621"
...
L0pull_TKIN<-L0pull_site[(L0pull_site$rawDataFileName=="NEON_D18_TKOT_20210620_AIS_SURVEY_L0_VA.zip"),]  
...
surveyPtsDF <- read.table("~/D18_TKOT_surveyPts_20210620.csv",
                          sep = ",",
                          header = T,
                          stringsAsFactors = F,
                          encoding = "UTF-8")
...
bankPoint1 <- data.frame("DSC_BANK1",-415,157,994.9886,"Transect_DSC")
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="DSC_BANK1"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="DSC_BANK1"]
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "OUT_DSC_XS14"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "OUT_DSC_XS38"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_BANK1"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "OUT_DSC_XS29"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "OUT_DSC_XS27"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "OUT_DSC_XS3"]
