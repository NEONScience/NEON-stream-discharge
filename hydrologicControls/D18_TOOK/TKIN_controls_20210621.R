...
#' discharge rating curve for Toolik Lake inlet for water years 2021-.
...
filepath <- "N:/Science/AQU/Controls/D18_TKIN_20210621"
...
L0pull_TKIN<-L0pull_site[(L0pull_site$rawDataFileName=="NEON_D18_TKIN_20210620_AIS_SURVEY_L0_VA.zip"),]  
...
surveyPtsDF <- read.table("~/D18_TKIN_surveyPts_20210620.csv",
                          sep = ",",
                          header = T,
                          stringsAsFactors = F,
                          encoding = "UTF-8")
...
bankPoint1 <- data.frame("DSC_BANK1",624,-1311,996.4402,"Transect_DSC")
...
dischargeXS1NorthStart<-dischargePointsXS1$N[dischargePointsXS1$name=="IN_DSC_XS1"]
dischargeXS1EastStart<-dischargePointsXS1$E[dischargePointsXS1$name=="IN_DSC_XS1"]
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_XS13"]
geo_controlType_in$controlRight[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "IN_DSC_XS47"]
...
geo_priorParameters_in$priorActivationStage[1] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_XS21"]
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_XS20"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "IN_DSC_XS60"]
