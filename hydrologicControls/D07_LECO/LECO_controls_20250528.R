...
#' discharge rating curve for LeConte Creek for water years 2025-
...
#   Bobby Hensley (2025-06-17)
#     Script for LECO 2025-05-28 created.
######################################################################################################################## 
...
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_0.60",staffGaugePoints$surveyPointID)]  
...
geo_priorParameters_in$priorActivationStage[2] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS5"]
geo_priorParameters_in$priorActivationStageUnc[2] <- 0.1 
geo_priorParameters_in$priorActivationStage[3] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS25"]
