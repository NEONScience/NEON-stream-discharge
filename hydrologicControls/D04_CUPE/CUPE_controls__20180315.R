...
#' discharge rating curve for Rio Cupeyes for water years 2012-2020.
...
filepath <- "N:/Science/AQU/Controls/D04_CUPE_20180315"
...
surveyPtsDF <- read.table(paste0(URIpath,"/NEON_D04_CUPE_GEOMORPH_20180315_L0_VE/CUPE_surveyPts_20180315.csv"),
                          sep = ",",
                          header = TRUE,
...
staffGaugePoints=subset(surveyPtsDF,surveyPtsDF$name=="SP_0.90M")
...
geo_controlType_in$controlLeft[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC10"]
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC25"]
...
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC10"]
...
geo_controlType_in$controlLeft[4] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC25"]
geo_controlType_in$controlRight[4] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_RFW"]
...
geo_controlType_in$channelSlopeUnc[4] <- 0.022  #Default slope uncertainty is equal to slope
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_LEW"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC7"]
...
geo_priorParameters_in$priorActivationStage[4] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC28"]
