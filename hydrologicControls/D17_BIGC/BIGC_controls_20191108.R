...
filepath <- "N:/Science/AQU/Controls/D17_BIGC_20191108"
...
surveyPtsDF <- read.table(paste0(URIpath,"/D17_BIGC_Raw_Survey_Data_20191108.CSV"),
                          sep = ",",
                          header = TRUE,
...
staffGaugePoints=subset(surveyPtsDF,surveyPtsDF$name=="SP_0.55M_NEW")
...
geo_controlType_in$controlLeft[1] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS14"]
...
geo_controlType_in$controlRight[2] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_RFH"]
...
geo_controlType_in$controlLeft[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_RFH"]
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_RB_PIN"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC_XS25"]
