...
staffGaugePoints=subset(surveyPtsDF,surveyPtsDF$MAPCODE=="Gauge_Temp")
...
staffGaugeElevation <- staffGaugePoints$H[grepl("SP2_0.50M",staffGaugePoints$NAME)]  
...
if(exectpart){
  ...
  staffGaugeZeroElevation<-(staffGaugePoints$H[staffGaugePoints$NAME=="SP2_0.50M"])-staffGaugeMeterMark
