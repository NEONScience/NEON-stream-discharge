...
#   Bobby Hensley (4/21/2022)
#     Modified for HOPB 2020 survey
######################################################################################################################## 
...
filepath <- "N:/Science/AQU/Controls/D01_HOPB_20201211"
URIpath <- paste(filepath,"filesToStack00131","stackedFiles",sep = "/")

# #Download data from API and store somewhere
# dataFromAPI <- neonUtilities::zipsByProduct(streamMorphoDPID,siteID,startdate="2020-10", enddate="2021-02",package="expanded",check.size=FALSE,savepath = filepath)
...
surveyPtsDF <- read.table(paste0(URIpath,"/NEON_D01_HOPB_GEOMORPH_20201211_L0_VE/D01_HOPB_surveyPts_20201211.CSV"),
                          sep = ",",
                          header = TRUE,
...
geo_controlType_in$controlRight[3] <- dischargePointsXS1$DistanceAdj[dischargePointsXS1$name == "DSC_XS27"]
