...
#     Created new set of controls for WY25.
######################################################################################################################## 
...
dataFromAPI <- neonUtilities::loadByProduct(streamMorphoDPID,siteID,startdate="2025-03", enddate="2025-03",
...
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_1.90M",staffGaugePoints$surveyPointID)]  

#' Manually enter the staff gauge reading of the point used above (found in surveyPointID name)
staffGaugeMeterMark<-1.90
