...
#' discharge rating curve for McDiffet Creek for water years 2025-
...
#   Bobby Hensley (2025-04-07)
#     Created new set of controls for WY25 from 2025-03-06 survey.
#   Bobby Hensley (2025-05-07)
#     Created new set of controls for WY25 from 2025-05-01 survey.
######################################################################################################################## 
...
dataFromAPI <- neonUtilities::loadByProduct(streamMorphoDPID,siteID,startdate="2025-05", enddate="2025-05",
...
staffGaugeElevation <- staffGaugePoints$elevation[grepl("SP_1.00M",staffGaugePoints$surveyPointID)]  
...
geo_controlType_in$controlLeft[2] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS21"]
...
geo_controlType_in$controlRight[3] <- dsc_surveyPoints$distanceAdj[dsc_surveyPoints$surveyPointID == "DSC_XS21"]
...
geo_priorParameters_in$priorActivationStage[1] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS11"]
...
geo_priorParameters_in$priorActivationStage[3] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS23"]
