...
#   Bobby Hensley (2025-03-06)
#     Created new set of controls for WY24.
######################################################################################################################## 
...
#' Adjusts the cross section elevations so the point of zero flow is correct (staff gage not at DSC transect)
ElevOff<-(-1.2)
