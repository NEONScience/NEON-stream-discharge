...
filepath <- "N:/Science/AQU/Controls/D04_GUIL__20170825"
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC4"]
