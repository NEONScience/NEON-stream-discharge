...
#' discharge rating curve for Rio Guilarte for water years 2019-.
...
filepath <- "N:/Science/AQU/Controls/D04_GUIL_20200312"
...
#Slope calculations - No water shots. Used slopes from 2017 Geomorph Survey
...
geo_priorParameters_in$priorActivationStage[2] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC29"]
...
geo_priorParameters_in$priorActivationStage[3] <- dischargePointsXS1$gaugeHeight[dischargePointsXS1$name == "DSC36"]
