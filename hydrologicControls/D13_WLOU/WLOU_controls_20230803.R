...
#' discharge rating curve for West Saint Louis Creek for water years 2023-
...
#     Script for WLOU 2023-08-03 created.
...
geo_priorParameters_in$priorActivationStage[2] <- dsc_surveyPoints$gaugeHeight[dsc_surveyPoints$surveyPointID == "DSC_XS12"]
