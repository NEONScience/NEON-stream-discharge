...
staffGaugeElevation <- staffGaugePoints$H[grepl("SP_0.50M2_TEMP",staffGaugePoints$name)]  
...
if(exectpart){
  ...
  staffGaugeZeroElevation<-(staffGaugePoints$H[staffGaugePoints$name=="SP_0.50M2_TEMP"])-staffGaugeMeterMark
